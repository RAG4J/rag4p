...
from rag4p.quality.retrieval_quality_service import obtain_retrieval_quality, read_question_answers_from_file
...
class TestRetrievalQualityService(unittest.TestCase):
    ...
    def test_read_question_answers_from_file_success(self):
        question_answers = read_question_answers_from_file("questions_answers.csv")
